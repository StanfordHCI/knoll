            ...
            <div style={{'display': 'flex', gap: '30px',}}>
                { console.log(props) }
                {
                    Object.keys(actionOptions).map(action => {
                        ...
                        return (
                            <button className={name} style={{fontSize: "18px"}} onClick={() => props.setSelected(action)}>
            ...
            <div>
                {
                    Object.keys(actionOptions).map(action => {
                        if (props.selected === action) {
                            return (
                                <div style={{'margin': '1em 0', fontSize: '22px', borderRadius: '8px', padding: '1.5em', width: '70%', background: '#414141', lineHeight: '1.5em'}}>
